...
export const APP_CATALOG: AivoryApp[] = [
  ...
  },
  {
    ...
    defaultAction: 'Send Email',
    fields: [
      { key: 'accessToken', label: 'Access Token', type: 'password', placeholder: 'ya29.a0...', required: true },
    ],
  },
  {
    id: 'google-drive',
  ...
  },
  {
    ...
    icon: '📊',
    iconPath: '/integrations/icons/google-sheets.svg',
    authType: 'apiKey',
    categories: ['Databases'],
  ...
  },
  {
    ...
    defaultAction: 'Send Message',
    fields: [
      { key: 'apiKey', label: 'Webhook URL or Bot Token', type: 'password', placeholder: 'https://discord.com/api/webhooks/...', required: true },
    ],
  },
  {
    id: 'microsoft-teams',
    ...
    defaultAction: 'Send Message',
    fields: [
      { key: 'accessToken', label: 'Access Token', type: 'password', placeholder: 'eyJ0eXAi...', required: true },
    ],
  },
  {
    id: 'outlook',
  ...
  },
  {
    ...
    icon: '💳',
    iconPath: '/integrations/icons/stripe.svg',
    authType: 'apiKey',
    categories: ['Finance'],
  ...
  },
  {
    ...
    fields: [
      { key: 'apiKey', label: 'API Key', type: 'password', placeholder: 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', required: true },
    ],
  },
  {
    id: 'asana',
    ...
    icon: '✅',
    iconPath: '/integrations/icons/asana.svg',
    authType: 'apiKey',
    categories: ['Productivity'],
    defaultAction: 'Create Task',
    fields: [
      { key: 'accessToken', label: 'Access Token', type: 'password', placeholder: '0/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', required: true },
    ],
  },
  {
    id: 'linear',
  ...
  },
  {
    ...
    defaultAction: 'Upload File',
    fields: [
      { key: 'accessToken', label: 'Access Token', type: 'password', placeholder: 'sl.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', required: true },
    ],
  },
  {
    id: 'aws-s3',
  ...
  },
  {
    ...
    fields: [
      { key: 'apiKey', label: 'API Key', type: 'password', placeholder: 'dG9rOi...', required: true },
    ],
  },
  {
    id: 'zendesk',
    ...
    fields: [
      ...
      { key: 'apiKey', label: 'API Token', type: 'password', placeholder: '...', required: true },
      { key: 'subdomain', label: 'Subdomain', type: 'text', placeholder: 'mycompany', required: true },
    ],
  },
  {
    id: 'shopify',
    ...
    icon: '🛍️',
    iconPath: '/integrations/icons/shopify.svg',
    authType: 'apiKey',
    categories: ['E-Commerce'],
    defaultAction: 'Create Order',
    fields: [
      { key: 'apiKey', label: 'Access Token', type: 'password', placeholder: 'shpat_...', required: true },
      { key: 'shop', label: 'Shop Name', type: 'text', placeholder: 'myshop', required: true },
    ],
  },
]

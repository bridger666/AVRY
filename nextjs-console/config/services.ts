...
export const SERVICES = {
  ...
  VPS_BRIDGE: process.env.VPS_BRIDGE_URL || 'http://43.156.108.96:3003',
  ...
  ZEROCLAW: process.env.ZEROCLAW_URL || 'http://43.156.108.96:3003',

  /** n8n base URL — accessed via VPS Bridge tunnel */
  N8N: process.env.N8N_URL || 'http://43.156.108.96:3003',

  /** n8n API key — server-side only */
  N8N_API_KEY: process.env.N8N_API_KEY || '',

  /** ARIA n8n webhook — routed via VPS Bridge */
  ARIA_WEBHOOK: process.env.ARIA_WEBHOOK_URL || 'http://43.156.108.96:3003/webhook/755fcac8-dc36-49e3-9553-67e62bac82e8',
